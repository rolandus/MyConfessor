...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</span></p>\n  <p><span class=\"label\">Diocese</span><span class=\"value\">";
  if (stack1 = helpers.diocese) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.diocese; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
