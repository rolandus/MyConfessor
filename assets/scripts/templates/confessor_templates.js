...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if (stack2 = helpers.state_select) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.state_select; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  if(stack2 || stack2 === 0) { buffer += stack2; }
